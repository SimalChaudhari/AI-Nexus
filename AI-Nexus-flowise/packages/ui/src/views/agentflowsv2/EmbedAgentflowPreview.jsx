...
const EmbedAgentflowPreview = () => {
    ...
    useEffect(() => {
        ...
        const loadFlow = async () => {
            try {
                ...
                const res = await chatflowsApi.getSpecificChatflow(id)
                const flow = res?.data
        ...
        if (id || searchParams.get('flowData')) {
            loadFlow()
        } else {
            setLoading(false)
        }
    ...
    }, [id, searchParams, setEdges, setNodes])
...
export default EmbedAgentflowPreview
