...
import { brandFonts, brandPalette } from 'src/theme/core';
  ...
  const renderBrandLock = (
    ...
    >
      ...
      <Typography variant="body2" sx={{ color: 'text.secondary' }}>
        Primary: {brandPalette.primary.main} | Secondary: {brandPalette.secondary.main} | Font:{' '}
        {brandFonts.primary}
      </Typography>
    </Box>
  );
    ...
    >
      ...
      <Scrollbar>
        <Stack spacing={6} sx={{ px: 2.5, pb: 5 }}>
          ...
          {!(hidePresets && hideFont) && renderBrandLock}
        </Stack>
      </Scrollbar>
    </Drawer>
  );
