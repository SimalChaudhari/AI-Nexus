...
export const _notifications = [...Array(9)].map((_, index) => ({
  ...
  title:
    ...
    (index === 1 &&
      `<p><strong>Jayvon Hull</strong> mentioned you in <strong><a href='#'>AI Nexus UI</a></strong></p>`) ||
    (index === 2 &&
...
export const _testimonials = [
  ...
  },
  {
    ...
    content: `Got a few posts after purchasing the product. The owner responded very fast and very helpfull. Overall the code is excellent and works very good. 5/5 stars!`,
  },
  {
